...
int main()
{
	...
	Cube* cube = new Cube("cube.obj", 0.0f, 0.0f, 0.0f);

	NianShou01* nianshou01 = new NianShou01("nianshou01.obj", -10.0f, 0.0f, 5.0f);
	NianShou02* nianshou02 = new NianShou02("nianshou02.obj", -10.0f, 0.0f, 5.0f);

	Human* human = new Human("Human.obj", -3.0f, 0.5f, 0.0f);

	Jiangshi* jiangshi = new Jiangshi("jiangshi.obj", 5.0f, 0.0f, -4.0f);
